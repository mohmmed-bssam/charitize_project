    ...
    <x-slot name="header">
        <div class="flex align-items-center justify-between">
            ...
            <a class="bg-green-600 p-1 px-8 rounded text-white hover:bg-green-500 duration-200"
                href="{{ route('dashboard.statistics.create') }}">{{ __('Add statistic') }}</a>
        </div>
    </x-slot>
                                ...
                                @forelse ($statistics as $statistic)
                                    <tr class="bg-neutral-primary border-b border-default">
                                        ...
                                        <td class="px-6 py-4 flex space-x-2 text-center">
                                            <a href="{{ route('dashboard.statistics.edit', $statistic->id) }}"
                                                class="text-blue-600 hover:underline"><i class="fas fa-edit"></i></a>
                                            <form action="{{ route('dashboard.statistics.destroy', $statistic->id) }}"
