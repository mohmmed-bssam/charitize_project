                    ...
                    <form action="{{ route('dashboard.settings') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-4 md:max-w-2xl items-center mt-4">
                            ...
                            <div class="col-span-2">
                                <x-text-input id="site_logo" class="block mt-1 w-full" type="file"
                                    name="site_logo" accept="image/*" />
                                    @if(isset($settings['site_logo']))
                                    <img class="p-0.5 mt-1 border rounded" width="80" src="{{ asset($settings['site_logo']) }}" alt="Site Logo" class="mt-2 h-16">
                                    @endif
                            </div>
                        </div>
                        <div class="grid grid-cols-4 md:max-w-2xl items-center mt-4">
                            ...
                            <div class="col-span-2">
                                <x-text-input id="call_us" class="block mt-1 w-full" type="text"
                                 name="call_us" :value=" $settings['call_us'] ?? '' " />
                            </div>
                        </div>
                        <div class="grid grid-cols-4 md:max-w-2xl items-center mt-4">
                            <div>
                            ...
                            <div class="col-span-2">
                                <x-text-input id="mail_us" class="block mt-1 w-full" type="email"
                                name="mail_us" :value=" $settings['mail_us'] ?? '' " />
                            </div>
                        </div>
                        <div class="grid grid-cols-4 md:max-w-2xl items-center mt-4">
                            <div>
                        ...
                        <div class="grid grid-cols-4 md:max-w-2xl items-center mt-4">
                            ...
                            <div class="col-span-2">
                                <x-text-input id="x" class="block mt-1 w-full" type="text"
                                 name="x" :value=" $settings['x'] ?? '' " />
                            </div>
                        </div>
                        <div class="grid grid-cols-4 md:max-w-2xl items-center mt-4">
                            <div>
                                <x-input-label for="instagram" class="block font-medium text-sm text-gray-700 !text-lg"
                                    :value="__('Instagram')" />
                            </div>
                            <div class="col-span-2">
                        ...
                        <div class="grid grid-cols-4 md:max-w-2xl items-center mt-4">
                            ...
                            <div class="col-span-2">
                                <x-text-input id="youtube" class="block mt-1 w-full" type="text"
